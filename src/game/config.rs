...
pub struct GameConfig {
    ...
    pub pipe_gap_center_jump_easy: f32,
    pub pipe_gap_center_jump_hard: f32,
    pub pipe_gap_jump_cadence_damp_min: f32,
...
impl Default for GameConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            pipe_gap_center_jump_easy: 60.0,
            pipe_gap_center_jump_hard: 90.0,
            pipe_gap_jump_cadence_damp_min: 0.8,
